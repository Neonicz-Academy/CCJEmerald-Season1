      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">ADD BUS PASS FORM</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Add Bus Pass</li>
            </ul>
          </div>
          <!-- Forms Section-->
          <section class="forms"> 
                ...
                <div class="col-lg-6">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      ...
                      <h3 class="h1">ENTER BUS PASS DETAILS</h3>
                    </div>
					<div class="freebirdFormviewerViewHeaderRequiredLegend" aria-hidden="true" dir="auto">* Required</div>
                    <div class="card-body">
                      
                      <form action="AddBuspassFormServlet" method="post">
                        <div class="form-group">
                          <label class="form-control-label">Name<span class="freebirdFormviewerComponentsQuestionBaseRequiredAsterisk" id="i8" aria-label="Required question"> *</span></label>
                        ...
                        <div class="form-group">       
                          ...
                          <input type="text" placeholder="Validity" class="form-control" name="validity" required>
                        </div>
                        <div class="form-group">       
                          ...
                          <input type="text" placeholder="Eligibility" class="form-control" name="desc" required>
                        </div>
                        <!-- <div class="form-group">       
                          <label class="form-control-label">Description</label>
                          <br/>
                          <textarea placeholder="Description if any"  rows="6" ></textarea>
                        </div> -->
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-sm-6 text-right">
                  <p>Design by <a href="#" class="external">Team Emerald</a>        Powered by <a href="http://www.neonicz.com/" class="external">Neonicz</a>Template by<a href="https://bootstrapious.com/admin-templates" class="external">Bootstrapious</a></p>
