...
<body>
	<div class="page login-page">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="info d-flex align-items-center">
							<div class="content">
								...
								<p>The Admin can Sign Up to the B.P.M.S. through this
									portal.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-6 bg-white">
						<div class="form d-flex align-items-center">
							<div class="content">
								<form class="form-validate" action="SignupServlet" method="post">
									<div class="form-group">
										<input id="register-username" type="text"
											name="registerUsername" required
									...
									<div class="form-group">
										<input id="register-email" type="email" name="registerEmail"
											...
											class="label-material">Email ID </label>
									</div>
									<div class="form-group">
								...
								<small>Already have an account? </small><a
									href="admin_login.jsp" class="signup">Login</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="copyrights text-center">
			<p>
				Design by <a href="https://bootstrapious.com" class="external">Team
					Emerald</a>
				<!-- Please do not remove the backlink to us unless you support further theme's development at https://bootstrapious.com/donate. It is part of the license conditions. Thank you for understanding :)-->
				Powered by <a href="http://www.neonicz.com/" class="external">Neonicz</a>
			</p>
		</div>
	</div>
	<!-- JavaScript files-->
